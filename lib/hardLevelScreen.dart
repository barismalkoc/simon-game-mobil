...
class HardLevelScreen extends StatefulWidget {
  ...
  HardLevelScreen({Key? key, required this.user}) : super(key: key);
...
class _HardLevelScreenState extends State<HardLevelScreen> {
  ...
  void startGame() {
    ...
    Future.delayed(const Duration(milliseconds: 300), () {
      if (_levelNumber == 0) {
        ...
        _pcSequence.add(Math.Random().nextInt(6) + 1);
  ...
  void endGame() {
    if(_levelNumber > widget.user.user_hard_score) {
      UserDao().updateHardLevelScore(widget.user, _levelNumber);
    }
    if(mounted) {
      setState(() {
      _result = false;
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                 ...
                 Align(
                    ...
                    Text(
                      _levelNumber == -1 ? "Game Over" : 'Hard : $_levelNumber',
                      style: const TextStyle(
                        color: Colors.amberAccent,
                        fontSize: 24,
                        fontFamily: "Schyler",
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        AnimatedOpacity(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              _playerSequence.add(6);
                              changeOpacity(OpacityColor.grey);
                              if (_pcSequence.length ==
                                  _playerSequence.length) {
                                if(mounted) {
                                  setState(() {
